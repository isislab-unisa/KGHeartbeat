...
function QualityBar({selectedKGs, setSelectedKG}) {
  ...
  return (
    ...
    <NavDropdown title="Availability" id="nav-dropdown" show={openDropdown === 'Availability'} onMouseEnter={() => handleMouseEnter('Availability')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Licensing" id="nav-dropdown"  show={openDropdown === 'Licensing'} onMouseEnter={() => handleMouseEnter('Licensing')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Interlinking" id="nav-dropdown" show={openDropdown === 'Interlinking'} onMouseEnter={() => handleMouseEnter('Interlinking')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Security" id="nav-dropdown" show={openDropdown === 'Security'} onMouseEnter={() => handleMouseEnter('Security')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Performance" id="nav-dropdown" show={openDropdown === 'Performance'} onMouseEnter={() => handleMouseEnter('Performance')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Accuracy" id="nav-dropdown" show={openDropdown === 'Accuracy'} onMouseEnter={() => handleMouseEnter('Accuracy')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Consistency" id="nav-dropdown" show={openDropdown === 'Consistency'} onMouseEnter={() => handleMouseEnter('Consistency')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Conciseness" id="nav-dropdown" show={openDropdown === 'Conciseness'} onMouseEnter={() => handleMouseEnter('Conciseness')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Reputation" id="nav-dropdown" show={openDropdown === 'Reputation'} onMouseEnter={() => handleMouseEnter('Reputation')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Believability" id="nav-dropdown" show={openDropdown === 'Believability'} onMouseEnter={() => handleMouseEnter('Believability')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Verifiability" id="nav-dropdown" show={openDropdown === 'Verifiability'} onMouseEnter={() => handleMouseEnter('Verifiability')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Currency" id="nav-dropdown" show={openDropdown === 'Currency'} onMouseEnter={() => handleMouseEnter('Currency')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Volatility" id="nav-dropdown" show={openDropdown === 'Volatility'} onMouseEnter={() => handleMouseEnter('Volatility')} onMouseLeave={handleMouseLeave} drop='down-centered'>
        <NavDropdown.Item eventKey="4.5"><Link to="/pages/Volatility" className='quality-link'>Timeliness frequency</Link></NavDropdown.Item>
    </NavDropdown>
    <NavDropdown title="Completeness" id="nav-dropdown" show={openDropdown === 'Completeness'} onMouseEnter={() => handleMouseEnter('Completeness')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Amount of data" id="nav-dropdown" show={openDropdown === 'Amount of data'} onMouseEnter={() => handleMouseEnter('Amount of data')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Representational-conciseness" id="nav-dropdown" show={openDropdown === 'Representational-conciseness'} onMouseEnter={() => handleMouseEnter('Representational-conciseness')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Representational-consistency" id="nav-dropdown" show={openDropdown === 'Representational-consistency'} onMouseEnter={() => handleMouseEnter('representational-consistency')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Understandability" id="nav-dropdown" show={openDropdown === 'Understandability'} onMouseEnter={() => handleMouseEnter('Understandability')} onMouseLeave={handleMouseLeave} drop='down-centered'>
    ...
    <NavDropdown title="Interpretability" id="nav-dropdown" show={openDropdown === 'Interpretability'} onMouseEnter={() => handleMouseEnter('Interpretability')} onMouseLeave={handleMouseLeave}drop='down-centered'>
    ...
    <NavDropdown title="Versatility" id="nav-dropdown" show={openDropdown === 'Versatility'} onMouseEnter={() => handleMouseEnter('Versatility')} onMouseLeave={handleMouseLeave} drop='down-centered'>
